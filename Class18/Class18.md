...
Pertusis (a.k.a. whooping cough) is a common lung infection caused by
bacteria B. Pertusis.

The CDC tracks the number of [reported data in the
...
Notice high number of cases before the wP vaccine and then a decline and
stabilization, followed by an increase in 1996 after the introduction of
the aP vaccine. Relatively stable from 1975 to 1996 and then unstable
again.
...
In the 1940s there was a high number of pertussis cases, but after the
introduction of the wP vaccine in 1946 it dropped. After the switch to
the aP vaccine in 1996, there was a small increase in the number of
cases. Possible explanations for this increase in the 2000s is because
of more sensitive PCR testing, vaccination hesistancy and distrust, and
bacterial evolution of the B. Pertusis bacterium.
...
The number of rows from the most recent is significantly higher than the
previous two years, and is slightly less than if you were to combine the
2021 and 2022 datasets. however it is about half of the 2020 dataset.
...
> Q. Is there a difference between aP vs wP vaccinated individuals with
> these values?
...
recognizing them over time are PT and FIM 2/3 because they get wider
with time and have boxes that have higher MFI in the middle visits..
However, PRN and FHA also show increases in the middle, with TT, OVA,
and DT having the weakest changes. These antigens may elicit stronger
responses.
